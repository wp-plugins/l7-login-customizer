...
class Jsm_Custom_Login_Functions {
	...
	public function jsm_custom_login_admin_init(){
		...
		add_settings_field( 'jsm_custom_logo_upload_options',  '<i class="fa fa-upload"></i> Logo Upload', array( $this, 'jsm_custom_login_logo_upload' ), 'logo-settings-customizer', 'jsm_custom_login_logo', array( 'label_for' => 'text_string' ) );
		add_settings_field( 'jsm_custom_logo_size',  '<i class="fa fa-arrows-alt"></i> Set Logo Size', array( $this, 'jsm_custom_login_logo_size' ), 'logo-settings-customizer', 'jsm_custom_login_logo', array( 'label_for' => 'logo_size' ) );
	...
	public function jsm_custom_login_logo_size() {
	    ...
	    $content = "<div class='input-group'><span class='input-group-addon'><i>Height</i></span><input id='logo_height' name='jsm_custom_login_options[logo_height]' type='text' value='" . esc_attr( $logo_height ) . "' class='form-control' /></div>";
	...
	public function jsm_custom_login_forms_background() {
		...
		$output = "<div class='input-group color-picker'><span class='input-group-addon'><i></i></span><input id='form_background' name='jsm_custom_login_options[form_background]' type='text' value='" . esc_attr( $text_string ). "' class='form-control' /></div>";
		$output .= "<span class='description'>6 digit hex color code</span>";
		echo $output;
	}
